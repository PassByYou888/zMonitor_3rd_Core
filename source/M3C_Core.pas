...
{$EndRegion 'core var'}
{$Region 'compatible'}
{$I M3C_Core.Compatible.inc}
{$EndRegion 'compatible'}

implementation

{$I M3C_Core.Cirtical.inc}
{$I M3C_Core.Atomic.inc}
{$I M3C_Core.MT19937.inc}
...
{$I M3C_Core.ThreadPost.inc}
{$I M3C_Core.ComputeThread.inc}

{$IFDEF FPC}
  {$I M3C_Core.FPCParallelFor.inc}
{$ELSE FPC}
  {$I M3C_Core.DelphiParallelFor.inc}
{$ENDIF FPC}

{$I M3C_Core.AtomVar.inc}
...
{$I M3C_Core.OrderData.inc}
{$I M3C_Core.BigList.inc}
{$I M3C_Core.Hash_Pair.inc}
