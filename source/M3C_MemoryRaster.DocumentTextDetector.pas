...
unit M3C_MemoryRaster.DocumentTextDetector;
...
{$IFDEF FPC}
  M3C_FPC.GenericList,
{$ENDIF FPC}
  M3C_Core, M3C_Geometry2D, M3C_Geometry3D, M3C_PascalStrings, M3C_UPascalStrings, M3C_UnicodeMixedLib, M3C_MemoryRaster, M3C_Status;
