...
uses M3C_Core, M3C_PascalStrings;
...
{$ELSE FPC}
  USystemChar = M3C_PascalStrings.SystemChar;
  USystemString = M3C_PascalStrings.SystemString;
  TUArrayChar = M3C_PascalStrings.TArrayChar;
  PUSystemString = M3C_PascalStrings.PSystemString;
  PUPascalString = M3C_PascalStrings.PPascalString;
{$ENDIF FPC}
