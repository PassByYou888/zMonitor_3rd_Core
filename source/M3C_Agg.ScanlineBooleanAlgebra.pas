...
(*
  ...
  ////////////////////////////////////////////////////////////////////////////////
*)
unit M3C_Agg.ScanlineBooleanAlgebra;
...
uses
  M3C_Agg.Basics,
  M3C_Agg.RasterizerScanLine,
  M3C_Agg.Scanline,
  M3C_Agg.RendererScanLine;
...
type
  ...
  public
    ...
    constructor Create1(f1: TAggBoolScanLineFunctor1; CoverShift: Cardinal = M3C_Agg.Basics.CAggCoverShift);
    constructor Create2(f2: TAggBoolScanLineFunctor2; CoverShift: Cardinal = M3C_Agg.Basics.CAggCoverShift);
  end;
...
constructor TAggBoolScanLineFunctor.Create1(f1: TAggBoolScanLineFunctor1;
  CoverShift: Cardinal = M3C_Agg.Basics.CAggCoverShift);
begin
