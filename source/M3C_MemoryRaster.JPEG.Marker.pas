...
unit M3C_MemoryRaster.JPEG.Marker;

{$I M3C_Define.inc}

interface

uses SysUtils, M3C_Core, M3C_PascalStrings, M3C_UPascalStrings, M3C_UnicodeMixedLib, M3C_MemoryStream,
{$IFDEF FPC}
  M3C_FPC.GenericList,
{$ENDIF FPC}
  M3C_MemoryRaster.JPEG.Type_LIB, M3C_MemoryRaster.JPEG.Huffman;
