...
uses Types,
  M3C_Core, M3C_UnicodeMixedLib, M3C_PascalStrings, M3C_UPascalStrings,
  M3C_ListEngine, M3C_MemoryStream, M3C_Cipher,
  M3C_Status, M3C_Geometry.Low, M3C_TextDataEngine, M3C_Geometry2D, M3C_Geometry3D,
  M3C_Json, M3C_Number,
{$IFDEF FPC}
  M3C_FPC.GenericList,
{$ELSE FPC}
  M3C_Delphi.JsonDataObjects,
{$ENDIF FPC}
  M3C_Compress;
