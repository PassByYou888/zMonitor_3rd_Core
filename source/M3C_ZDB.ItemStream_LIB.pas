...
unit M3C_ZDB.ItemStream_LIB;

{$I M3C_Define.inc}

interface

uses SysUtils, M3C_Core, Classes, M3C_UnicodeMixedLib, M3C_ZDB.ObjectData_LIB, M3C_ZDB, M3C_MemoryStream,
  M3C_PascalStrings, M3C_UPascalStrings;
