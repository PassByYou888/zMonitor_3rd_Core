...
uses
  M3C_Core, M3C_PascalStrings, M3C_UPascalStrings, M3C_Status, M3C_MemoryStream,
  M3C_MemoryRaster, M3C_MemoryRaster.JPEG.Image_LIB, M3C_MemoryRaster.JPEG.Type_LIB, M3C_MemoryRaster.JPEG.MapIterator;
...
type
  ...
  TMemoryJpegRaster = class(TCore_Object)
  private
...
procedure TMemoryJpegRaster.LoadFromStream(Stream: TMS64);
begin
...
procedure TMemoryJpegRaster.SaveToStream(Stream: TMS64);
begin
