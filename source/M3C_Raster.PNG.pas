...
uses M3C_Core, M3C_PascalStrings, M3C_UPascalStrings, M3C_UnicodeMixedLib, M3C_MemoryStream, M3C_MemoryRaster, M3C_Geometry2D;

function IsPNG(const Stream: TCore_Stream): Boolean;
procedure LoadRasterFromPNG(raster: TMemoryRaster; Stream: TCore_Stream);
procedure SaveRasterToPNG(raster: TMemoryRaster; Stream: TCore_Stream);
