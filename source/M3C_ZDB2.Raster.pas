...
{$IFDEF FPC}
  M3C_FPC.GenericList,
{$ENDIF FPC}
  M3C_PascalStrings, M3C_UPascalStrings, M3C_UnicodeMixedLib, M3C_Status, M3C_MemoryStream,
  M3C_DFE, M3C_ZDB2, M3C_Cipher, M3C_MemoryRaster;
...
type
  ...
  private
    ...
    FID: Integer;
    FData: TRaster;
    FRasterFormat: TRasterSaveFormat;
    FIsChanged: Boolean;
  public
    ...
    procedure Remove;
    function GetData: TRaster;
    property Data: TRaster read GetData;
    property Data_Direct: TRaster read FData;
    property ID: Integer read FID;
    property RasterFormat: TRasterSaveFormat read FRasterFormat write FRasterFormat;
...
begin
  ...
  FData := nil;
  FRasterFormat := TRasterSaveFormat.rsRGB;
  FIsChanged := False;
end;
...
function TZDB2_Raster.GetData: TRaster;
begin
  if FData = nil then
    begin
      FData := NewRaster();
