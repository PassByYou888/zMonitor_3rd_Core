...
uses
  M3C_Core, M3C_JLS.Global, M3C_JLS.Encoder, M3C_JLS.Decoder;

type
  PJlsParameters       = M3C_JLS.Global.PJlsParameters;
  TJlsParameters       = M3C_JLS.Global.TJlsParameters;
  TJlsCustomParameters = M3C_JLS.Global.TJlsCustomParameters;
