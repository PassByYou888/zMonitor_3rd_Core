...
unit M3C_MemoryRaster.JPEG.Lossless;
...
uses
  M3C_Core, M3C_PascalStrings, M3C_UPascalStrings, M3C_MemoryRaster.JPEG.Type_LIB, M3C_MemoryRaster.JPEG.Marker;
...
uses M3C_MemoryRaster.JPEG.Coder, M3C_MemoryRaster.JPEG.Image_LIB;
