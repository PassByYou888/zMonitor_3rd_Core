...
{ ****************************************************************************** }
unit M3C_MemoryRaster.MorphologyExpression;
...
{$ENDIF FPC}
  TypInfo, Variants,
  M3C_PascalStrings, M3C_UPascalStrings, M3C_Core, M3C_UnicodeMixedLib, M3C_ListEngine, M3C_Status, M3C_Parsing, M3C_DFE, M3C_MemoryStream,
  M3C_Expression, M3C_OpCode, M3C_Geometry2D, M3C_Geometry3D, M3C_MemoryRaster, M3C_DrawEngine;
...
type
  ...
  public
    ...
    procedure InputRaster(stream: TCore_Stream); overload;
...
procedure TMorphExp.InputRaster(stream: TCore_Stream);
begin
  FInData.Clear;
