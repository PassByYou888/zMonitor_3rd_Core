...
uses M3C_Core, M3C_ZDB.ObjectData_LIB, M3C_UnicodeMixedLib, M3C_PascalStrings, M3C_UPascalStrings, M3C_ListEngine, M3C_ZDB2, M3C_HashList.Templet;

type
  TItemHandle = M3C_ZDB.ObjectData_LIB.TItemHandle_;
  PItemHandle = ^TItemHandle;
  TFieldHandle = M3C_ZDB.ObjectData_LIB.TField;
  PFieldHandle = ^TFieldHandle;
  TItemSearch = M3C_ZDB.ObjectData_LIB.TSearchItem_;
  PItemSearch = ^TItemSearch;
  TFieldSearch = M3C_ZDB.ObjectData_LIB.TSearchField_;
  PFieldSearch = ^TFieldSearch;
  TItemRecursionSearch = M3C_ZDB.ObjectData_LIB.TRecursionSearch_;
...
uses M3C_ZDB.ItemStream_LIB,
  M3C_MemoryStream,
  M3C_Status,
  M3C_ZDB2.FileEncoder;
...
var
  FieldHnd: TFieldHandle;
  i: Integer;
  h: M3C_ZDB.ObjectData_LIB.THeader;
begin
  Result := False;
  SetLength(output, 0);
