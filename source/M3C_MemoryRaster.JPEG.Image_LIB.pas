...
unit M3C_MemoryRaster.JPEG.Image_LIB;
...
uses Classes, SysUtils,
  M3C_Core, M3C_MemoryStream, M3C_PascalStrings,
  M3C_MemoryRaster.JPEG.Type_LIB,
  M3C_MemoryRaster.JPEG.Marker,
  M3C_MemoryRaster.JPEG.MapIterator,
  M3C_MemoryRaster.JPEG.DICT,
  M3C_MemoryRaster.JPEG.BitStream,
  M3C_MemoryRaster.JPEG.Huffman,
  M3C_MemoryRaster.JPEG.Lossless,
  M3C_MemoryRaster.JPEG.ColorTransforms,
  M3C_MemoryRaster.JPEG.Coder;
