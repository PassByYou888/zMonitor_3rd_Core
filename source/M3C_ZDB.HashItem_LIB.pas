...
{ * fast StreamQuery                                                           * }
{ ****************************************************************************** }
unit M3C_ZDB.HashItem_LIB;

{$I M3C_Define.inc}

interface

uses SysUtils, M3C_ZDB, M3C_ZDB.ItemStream_LIB, M3C_Core, M3C_PascalStrings, M3C_UPascalStrings, M3C_ListEngine;
