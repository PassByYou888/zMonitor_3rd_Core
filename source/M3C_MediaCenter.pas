...
{$IFDEF FPC}
  M3C_FPC.GenericList,
{$ENDIF FPC}
  M3C_Core, M3C_PascalStrings,
  M3C_ZDB.HashField_LIB, M3C_UnicodeMixedLib,
  M3C_ZDB, M3C_MemoryStream, M3C_TextDataEngine, M3C_ListEngine, M3C_ZDB.HashItem_LIB,
  M3C_DFE, M3C_ZDB.ObjectData_LIB, M3C_ZDB.ItemStream_LIB,
  M3C_ZDB2, M3C_ZDB2.FileEncoder,
  M3C_Geometry2D;
