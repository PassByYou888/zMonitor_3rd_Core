...
{$IFDEF MSWINDOWS} Windows, {$ENDIF MSWINDOWS}
  System.IOUtils,
{$ENDIF FPC}
  SysUtils, Types, Math, Variants, M3C_Core,
  M3C_PascalStrings, M3C_UPascalStrings, M3C_ListEngine;
...
{$IF Defined(WIN32) or Defined(WIN64)}
  M3C_MD5,
{$ENDIF}
  M3C_Cipher, M3C_Status, M3C_MemoryStream;
