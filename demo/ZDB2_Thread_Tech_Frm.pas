...
uses
  ...
  M3C_Core, M3C_PascalStrings, M3C_UPascalStrings, M3C_UnicodeMixedLib, M3C_Cipher, M3C_Status, M3C_Notify, M3C_MemoryStream,
  M3C_ListEngine,
  M3C_ZDB2, M3C_ZDB2.Thread.Queue, M3C_ZDB2.Thread;
...
type
  ...
  TZDB2_Thread_Tech_Form = class(TForm)
    Memo: TMemo;
    runButton: TButton;
    fpsTimer: TTimer;
...
var
  ZDB2_Thread_Tech_Form: TZDB2_Thread_Tech_Form;
...
procedure TZDB2_Thread_Tech_Form.fpsTimerTimer(Sender: TObject);
var
  n: U_String;
begin
  CheckThread;
...
procedure TZDB2_Thread_Tech_Form.runButtonClick(Sender: TObject);
begin
  if Sim_Running then
    begin
      Sim_Running := False;
...
procedure TZDB2_Thread_Tech_Form.backcall_DoStatus(Text_: SystemString; const ID: Integer);
begin
  Memo.Lines.Add(Text_);
end;

procedure TZDB2_Thread_Tech_Form.Do_Init_Sim_Mem_DB;
var
  i: Integer;
...
procedure TZDB2_Thread_Tech_Form.Do_Sim_Add;
var
  m64: TMem64;
  inst: TCustom_Data;
begin
...
procedure TZDB2_Thread_Tech_Form.Do_Sim_Remove;
begin
  TCompute.Sleep(100);
...
procedure TZDB2_Thread_Tech_Form.Do_Sim_Parallel_Load;
begin
...
procedure TZDB2_Thread_Tech_Form.Do_Sim_For;
begin
...
constructor TZDB2_Thread_Tech_Form.Create(AOwner: TComponent);
begin
...
destructor TZDB2_Thread_Tech_Form.Destroy;
begin
